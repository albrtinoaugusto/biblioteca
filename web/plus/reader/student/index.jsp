            ...
            <div class="content-inner-all">
                ...
                <div class="container-fluid">
                    ...
                    <div class="middle_forms">
                        ...
                        <form action="${pageContext.request.contextPath}/writestudent" method="post" id="adminpro-form" class="adminpro-form">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="custom_label" style="font-size: 12pt">
                                            <br/>
                                            <b>Adicionar Estudante</b>
                                        </div>
                                    </div>
                                </div>
                                <br/>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="name_field">Escola onde Estuda</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="surname_field">Curso</label>
                                                <input type="text" class="form-control" id="author_field" name="course" placeholder="Curso" maxlength="90" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="surname_field">Turma</label>
                                                <input type="text" class="form-control" id="author_field" name="class" placeholder="Turma" maxlength="90" required/>
                                            </div>
                                        </div>
                                    </div>
