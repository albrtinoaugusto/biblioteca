            ...
            <div class="content-inner-all">
                ...
                <div class="container-fluid">
                    ...
                    <div class="middle_forms">
                        ...
                        <form action="${pageContext.request.contextPath}/writeprofessor" method="post" id="adminpro-form" class="adminpro-form">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="custom_label" style="font-size: 12pt">
                                            <br/>
                                            <b>Adicionar Professor</b>
                                        </div>
                                    </div>
                                </div>
                                <br/>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="name_field">Disciplina que Leciona</label>
                                                <input type="text" class="form-control" id="name_field"  name="subject" placeholder="Disciplina que Leciona" maxlength="50" required/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="surname_field">Curso de Formação</label>
